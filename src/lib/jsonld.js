export default {
  ...
  EducationalOccupationalProgram: {
    name: "Polonya'da Dil Hazırlık Eğitimi | Olymposedu",
    description:
  ...
  polandLife: {
    name: "Polonya'da Yaşam | Olymposedu",
    description:
  ...
  iletisim: {
    name: "İletişim | Olymposedu",
    url: "https://olymposedu.com/iletisim",
    description:
      "Olympos Edu Eğitim Danışmanlığı iletişim numaralarımız adresimiz ve daha fazlası.",
    image: {
      "@type": "ImageObject",
  ...
  universitelerimiz: {
    name: "Universitelerimiz | Olymposedu",
    url: "https://olymposedu.com/universitelerimiz",
    description: "Polonya'daki üniversiteler ve daha fazlası.",
    image: {
      "@type": "ImageObject",
