...
export const Hero = ({
  ...
  const data = [
    <span
      className={`text-rose-600 font-bold tracking-tight text-2xl hidden lg:flex ${font.className}`}
    >
      {subHeader}
    </span>,
  ...
  return (
    <>
      <div
        className={`w-full h-screen overflow-hidden relative ${font.className}`}
      >
        <video
